...
{if $post->hasComments}
	{capture $commentsNumber}
		<span class="comments-count">{$post->commentsNumber}</span>
	{/capture}
	<h2 class="comments-title">{!_n '%s Comment','%s Comments',$post->commentsNumber|printf:$commentsNumber}</h2>
