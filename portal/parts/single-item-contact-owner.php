...
<div n:class="contact-owner-container, $disabled ? contact-owner-disabled">
	...
	{if !$disabled}
	<a href="#contact-owner-popup-form" id="contact-owner-popup-button" class="contact-owner-popup-button ait-button item"><i class="fa fa-envelope"></i>{$settings->contactOwnerButtonTitle|trimWords:10}</a>
	...
	{else}
	<a href="#contact-owner-popup-form" id="contact-owner-popup-button" class="contact-owner-popup-button ait-button item">{$settings->contactOwnerButtonDisabledTitle|trimWords:10}</a>
	{/if}
</div>
