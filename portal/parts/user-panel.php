...
<div class="user-panel{if !is_user_logged_in()} not-logged{/if}">
	...
	{if is_user_logged_in()}
		...
		<div class="user-info">
			...
			<div class="user-name">{__ 'Welcome'}, {$currentUser->user_nicename}</div>
		</div>
		...
		<div class="user-actions">
			...
			{var $adminMenusUrl = 'edit.php?post_type=ait-food-menu&author=' . $currentUser->ID}
			{var $menusCount = intval(count_user_posts($currentUser->ID, "ait-food-menu"))}
			<a href="{admin_url($adminMenusUrl)}" title="{__ 'Food Menu'}" class="user-foodmenus">{__ 'My Menu'}<span>{$menusCount}</span></a>
			{/if}
	...
	{else}
		...
		<div class="user-login">
			<span class="welcome-text">{__ 'Welcome'}</span> <a href="#" class="toggle-button">{__ 'Login or Register'}</a>
		</div>
